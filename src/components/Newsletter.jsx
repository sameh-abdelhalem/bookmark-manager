      ...
      <div className="max-w-lg mx-auto py-24">
        ...
        <form className="flex flex-col items-start justify-center max-w-2xl mx-auto space-y-6 text-base px-6 md:flex-row md:space-y-0 md:space-x-4 md:px-0">
          ...
          <div className="flex flex-col justify-between items-center mx-auto md:flex-row md:mx-0">
            ...
            <input
              type="submit"
              className="inline-flex px-6 py-3 font-semibold text-center text-white duration-200 transform rounded-lg cursor-pointer focus:outline-none bg-softRed hover:bg-white border-2 border-softRed hover:text-softRed"
              value="Contact Us"
            />
          </div>
        </form>
